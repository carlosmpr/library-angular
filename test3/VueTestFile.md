...
### Dependencies
- The code uses the `@heroicons/vue` library to import icons for display in the component. Make sure to have this library installed and configured in your project for the icons to render correctly.
